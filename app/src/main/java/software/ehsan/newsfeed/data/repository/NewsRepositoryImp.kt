...
class NewsRepositoryImp @Inject constructor(
    ...
    override suspend fun getNews(keyword: String, userId: String): Flow<PagingData<Article>> {
    ...
    override suspend fun getTopHeadlineNewsByCategory(
        category: String,
        userId: String
    ...
    override suspend fun getTopHeadlineNewsByCountry(
        country: String,
        userId: String
    ): Flow<PagingData<Article>> {
        val flow = Pager(PagingConfig(pageSize = PAGE_SIZE)) {
